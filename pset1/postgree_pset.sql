-- CRIANDO MEU USUÁRIO COM PERMISSÕES
...
-- CRIANDO UM BANCO DE DADOS DA UVV
...
-- CRIANDO ESQUEMA ELMASRI PARA O MEU USUÁRIO
...
-- CRIANDO UMA TABELA PARA O DEPARTAMENTO
...
-- TRANSFORMANDO O NOME DEPARTAMENTO EM UMA CHAVE ÚNICA (AK)
...
-- TRANSFORMANDO O PROJETO EM UMA CHAVE ÚNICA 
...
-- CRIAR A TABELA DOS LOCAIS DO DEPARTAMENTO
...
-- RELACIONAMENTO DAS TABELAS PARA ADICIONAR UMA FOREIGN KEY 
